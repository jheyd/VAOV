...
/**
 * Utility class for asking questions (and receiving answers) on the command
 * line
 * 
 * @author dunkelzahn
 * 
...
public class Util {
	...
	public static char[] askCharArray(String question) {
		...
		java.io.BufferedReader systemInReader = new java.io.BufferedReader(
	 ...
	 */
	public static Integer askIndexChoice(String question,
	...
	public static int askInt(String question) {
		Integer i;
		while ((i = askInteger(question)) == null)
			; // if input String is empty, ask again
		return i;
	}
