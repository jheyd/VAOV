...
public class MessageHandler {
	 ...
	 */
	public static boolean sendMessage(String s, Account author)
	...
	@SuppressWarnings("unchecked")
	public static void sendNewAccount(Account acc)
			throws IllegalFormatException, KeyException, VerificationException {
	 ...
	 * 
	 * @param name
	 *            the name to create the Ini with
	 * @param text
	 *            the text to create the Ini with
	 * @param targetID
	 *            the Topic to create the Ini in.
	 * @param author
	 *            the Account to sign the Message with
	 * @throws IOException
	 * @throws IllegalFormatException
	 ...
	 *            the text to create the Ini with
	 * @param tags
	 *            the tags to create the Topic with
	 * @param author
	 *            the Account to sign the Message with
	 * @throws IOException
	 * @throws IllegalFormatException
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void sendNickchange(String newNick, Account author)
			throws IllegalFormatException, KeyException, VerificationException {
		JSONObject jo1 = new JSONObject();
		JSONObject jo2 = new JSONObject();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void sendVote(Vote vote, Account author)
			throws IllegalFormatException, KeyException, VerificationException {
		JSONObject jo1 = new JSONObject();
		JSONObject jo2 = new JSONObject();
