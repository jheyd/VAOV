...
/**
 * This class manages the voting part of this application: Key and Account
 * Management, sending signed Messages, controlling Signatures of other
 * Messages. Dies ist ein Versuch, Abstimmungs- und Antragsanzeigetool
 * voneinander zu trennen. Diese Klasse ist darauf ausgelegt, allein ausfühbar
 * und mittels Texteingaben steuerbar zu sein (bspw. ID eines Antrags eingeben
 * um über diese Antrag abzustimmen).
 * 
 * @author dunkelzahn
 * 
 */
...
public class VoteManager {
	public static final String[] commandNames = new String[] { "message",
			"vote", "newIni", "newTopic" };
	public static final String[] commandShortNames = new String[] { "m", "v",
			"i", "t" };
	 ...
	 * 
	 * @param target
	 *            the name of the user who shall receive the message
	 * @param message
	 *            the message text
	 * @throws KeyException
	 ...
	 * @throws IOException
	 */
	public void message(String target, String message) throws KeyException,
			IOException, IllegalFormatException, VerificationException {
	 ...
	 * 
	 * @param topicID
	 *            the ID of the Topic to create the Ini in
	 * @param name
	 *            the name / title of the Ini to create
	 * @param text
	 *            the text of the Ini
	 */
	 ...
	 * 
	 * @param targetID
	 *            ID code of the targat Topic (typically somthing like
	 *            "TOP12345")
	 * @param voteString
	 *            the encoded vote String (typically something like "YYNYN")
	 * @throws VerificationException
	 * @throws KeyException
	 * @throws IllegalFormatException
	 * @throws IOException
	 */
	public void vote(String targetID, String voteString) throws IOException,
