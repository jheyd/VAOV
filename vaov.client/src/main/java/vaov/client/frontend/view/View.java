package vaov.client.frontend.view;
...
import vaov.client.frontend.control.Control;
import vaov.client.frontend.model.Pair;
...
public class View extends JFrame implements ActionListener {
	...
	public View() {
		...
		// LayoutManager des JFrames, um die Elemente beim Fenstervergroessern
		// links oben zu halten
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btn_Abstain)
			// control.voteWithLoadedAccount(new Vote(new
			// boolean[]{false,false},Util.getIniIDFromJListSelectedValue(this.list.getSelectedValue())));
			this.setButtonsEnabled(false);
		if (e.getSource() == this.btn_VoteYes)
			// control.voteWithLoadedAccount(new Vote(new
			// boolean[]{true,false},Util.getIniIDFromJListSelectedValue(this.list.getSelectedValue())));
			this.setButtonsEnabled(false);
		if (e.getSource() == this.btn_VoteNo)
			// control.voteWithLoadedAccount(new Vote(new
			// boolean[]{false,true},Util.getIniIDFromJListSelectedValue(this.list.getSelectedValue())));
			this.setButtonsEnabled(false);
	...
	private void setLayout() {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						.addContainerGap()
						.addComponent(list, GroupLayout.DEFAULT_SIZE, 52,
								Short.MAX_VALUE)
						.addGap(18)
