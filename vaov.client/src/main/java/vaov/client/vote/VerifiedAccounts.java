...
public class VerifiedAccounts {
	...
	private VerifiedAccounts() throws VerificationException, IOException,
		...
		try {
			...
			if (!base64.equals(Config.getLegitimateChecksum()))
				// throw new
				// VerificationException("Checksumme für Liste mit legitimierten Accounts stimmt nicht!");
				// TODO: Must throw an exception. But for developing purposes a
				// simple string is easier.
				System.out
						.println("Checksumme für Liste mit legitimierten Accounts stimmt nicht!");
